package com.zy.rpc.thrift.server;
...
import com.zy.rpc.thrift.server.properties.ThriftServerDiscoveryProperties;
import com.zy.rpc.thrift.server.properties.ThriftServerHealthCheckProperties;
...
@Configuration
@AutoConfigureAfter({ThriftServerAutoConfiguration.class, UtilAutoConfiguration.class})
...
public class ThriftServerDiscoveryConfiguration {
    ...
    @Bean
    public Consul thriftConsulClient(ThriftServerProperties thriftServerProperties, InetUtils inetUtils) throws UnknownHostException {
...
//        String serverHostAddress = "localhost";
        String serverHostAddress = inetUtils.findFirstNonLoopbackHostInfo().getIpAddress();
