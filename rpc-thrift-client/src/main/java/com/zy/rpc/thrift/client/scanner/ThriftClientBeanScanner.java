package com.zy.rpc.thrift.client.scanner;


import com.zy.rpc.thrift.client.annotation.ThriftClient;
import com.zy.rpc.thrift.client.common.ThriftClientDefinitionProperty;
import com.zy.rpc.thrift.client.common.ThriftServiceSignature;
import com.zy.rpc.thrift.client.exception.ThriftClientConfigException;
import com.zy.rpc.thrift.client.exception.ThriftClientInstantiateException;
    ...
    protected Set<BeanDefinitionHolder> doScan(String... basePackages) {
        ...
        for (BeanDefinitionHolder definitionHolder : definitionHolders) {
            ...
            ThriftServiceSignature serviceSignature = new ThriftServiceSignature(
                    thriftClient.serviceId(), thriftClient.refer(), thriftClient.balancer());
